                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 center991 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                        <article>
                            ...
                            <div class="thumbnail">
                                <a class="overlay" href="#"><img class="" src="http://uniqueagri.com/wp-content/uploads/2016/04/unigain.png" alt=""></a>
                            </div>
                            <h4 class="text-primary">
                                UNIQUE PLANT GROWTH STIMULANT
                            </h4>
                            <h4>
                                PRODUCT HIGHLIGHTS:
                            </h4>
                            <ul class="simple-list">
                                ...
                                <li>
                                    <a href="#">
                                        Improves soil quality and stimulates plant growth.
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        Compatible with organic, compost and vermi compost fertilizers.
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="col-md-8 col-sm-12 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                        ...
                        <ul class="simple-list">
                            <li>
                                <a href="#">
                                    Suitable for all types of crops and plants.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    Supplies all essential nutrients for plant growth.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    Supports photosynthesis process by increasing size of leaves.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                            ...
                            <li>
                                <a href="#">
                                    It reduces fruits and flower droppings.
                                </a>
                            </li>
                            <li>
                                <a href="#">
