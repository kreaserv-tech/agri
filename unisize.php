                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 center991 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                        <article>
                            ...
                            <div class="thumbnail">
                                <a class="overlay" href="#"><img class="" src="http://uniqueagri.com/wp-content/uploads/2016/04/unisize.png" alt=""></a>
                            </div>
                            <h4 class="text-primary">
                                UNIQUE PRODUCT FOR FRUIT AND FLOWER BEARING PLANTS
                            </h4>
                            <h4>
                                PRODUCT HIGHLIGHTS:
                            </h4>
                            <ul class="simple-list">
                                ...
                                <li>
                                    <a href="#">
                                        Suitable for fruit and flower bearing plants.
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="col-md-8 col-sm-12 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                        ...
                        <ul class="simple-list">
                            ...
                            <li>
                                <a href="#">
                                    Increases chlorophyll concentration there by increases photosynthesis process.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                            ...
                            <li>
                                <a href="#">
                                    Enhances fruit setting and reduces fruit / flower dropping.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    Used along with organic or chemical fertilizer increases its rate of absorption.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    Increases immune plower of plant.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    Healthy plants gives better Agro output.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    It increases weight and size of fruit.
                                </a>
                            </li>
                        </ul>
                    </div>
