                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 center991 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                        <article>
                            ...
                            <div class="thumbnail">
                                <a class="overlay" href="#"><img class="" src="http://uniqueagri.com/wp-content/uploads/2016/12/uniag.png" alt=""></a>
                            </div>
                            <h4 class="text-primary">
                                UNIQUE MULTIFUNCTIONAL PRODUCT FOR OVERALL DEVELOPMENT OF PLANT
                            </h4>
                            <h4>
                                PRODUCT HIGHLIGHTS:
                            </h4>
                            <ul class="simple-list">
                                ...
                                <li>
                                    <a href="#">
                                        Available in powder form, so easy to handle.
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="col-md-8 col-sm-12 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                        ...
                        <ul class="simple-list">
                            <li>
                                <a href="#">
                                    Acts mainly on the hydric balance of the plant strengthening the cellular walls in such a way that they increase resistance to unfavourable climatic conditions.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                            ...
                            <li>
                                <a href="#">
                                    Helps in proper ripening of fruits.
                                </a>
                            </li>
                            <li>
                                <a href="#">
                            ...
                            <li>
                                <a href="#">
                                    Very effective chelating agents.
                                </a>
                            </li>
                            <li>
                                <a href="#">
